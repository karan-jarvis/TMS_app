          ...
          () => Column(
            children: [
              MyTextBox(
                ...
                onChanged: (String? val) => leaveController.checkLeave(val!),
                          ...
                          Obx(
                            () => DropdownButton<String>(
                              ...
                              onChanged: (String? newValue) {
                                leaveController.leaveType.value = newValue!;
                              },
                              items: [
                                'Half leave',
                                "Full leave",
                      ...
                      leaveController.leaveType.value == "Half leave"
                          ? Column(
                              ...
                              children: [
                                ...
                                Obx(
                                  () => DropdownButton<String>(
                                    value: leaveController.leaveDuration.value,
                                    isDense: true,
                                    hint: const Text("Select The Role"),
                                    onChanged: (String? newValue) {
                                      leaveController.leaveDuration.value =
                                          newValue!;
                                    },
                                    items: [
                                      '1 hour',
                              ...
                              InkWell(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                      ...
                                      border: Border.all()),
                                  child: Text(leaveController.startDate.value),
                                ),
                              ),
                            ],
                          ),
                              ...
                              InkWell(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                      borderRadius: BorderRadius.circular(20),
                                      border: Border.all()),
                                  child: Text(leaveController.endDate.value),
                                ),
                              ),
                            ],
                          ),
              ...
              CommonButton(
                ...
                onPressed: () {
                  showSnackBar(
                      context: context,
                      title:
                          "Your leave applicaiton has been sended to author please wait for fonfirmation");
                },
              ),
            ],
          ),
