...
class AppPreference {
  ...
  Future setUserName({required String user}) async {
    await _preferences.setString(PreferencesKey.userName, user);
  }

  String? getUser() {
    String? userName = _preferences.getString(PreferencesKey.userName);
    return userName;
  }
